...
const notifications = [
  { id: 'KBL 175G', time: '10/02/2023 14:21', location: 'Kariobangi Depot', color: 'bg-red-500' },
  { id: 'KBL 115G', time: '10/02/2023 14:19', location: 'ACC MSA', color: 'bg-red-500' },
  { id: 'KBL 165G', time: '10/02/2023 14:17', location: 'Mombasa Depot', color: 'bg-green-500' },
  { id: 'KBO 165G', time: '10/02/2023 14:17', location: 'Mtwapa Depot', color: 'bg-orange-500' },
]
      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          <div className="flex items-center">
            ...
            <nav className="ml-6">
              <a href="#" className="text-gray-500 hover:text-gray-700 px-3 py-2">Tracking</a>
              <a href="#" className="text-gray-500 hover:text-gray-700 px-3 py-2">Analytics</a>
            </nav>
          </div>
          <div className="flex items-center">
            ...
            <button className="ml-4 px-4 py-2 bg-blue-600 text-white rounded-md">Go Track</button>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <button className="mt-4 w-full py-2 bg-blue-600 text-white rounded-md">Current status</button>
          </div>
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <button className="mt-4 w-full py-2 bg-blue-600 text-white rounded-md">Movement</button>
          </div>
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <button className="mt-4 w-full py-2 bg-blue-600 text-white rounded-md">Violations</button>
          </div>
        </div>
        <div className="mt-8 grid grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            <h2 className="text-lg font-semibold mb-4">Assets Service Summary</h2>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie
        ...
        <ul>
          {notifications.map((notification, index) => (
            <li key={index} className="mb-4 flex items-start">
              <div className={`w-2 h-2 rounded-full mt-2 mr-2 ${notification.color}`}></div>
              <div>
